...
indicators.forEach((indicator, x) => {
  indicator.addEventListener('click', () => {
    slider.style.transform = 'translateX(' + x * -20 + '%)';
...
function select_card(testx, test_a, test_b, test_c, test_d) {
...
function unselect_card(test_y){
  document.querySelector(test_y).classList.remove('green');
  document.querySelector(test_y).classList.add('white');
  document.querySelector(test_y +' img').src = 'images/greenquotes.png'
  document.querySelector(test_y +' p').style.color = '#031d5b';
  document.querySelector(test_y +' :last-child').style.color = '#031d5b';
}
